...
const _CATEGORIES_RAW: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { slug: "lucid-wizard", title: "LUCID-Verpackungsregister", desc: "5-Step-Wizard: Pflicht-Check, Firmen-Daten, Material-Mengen (6 Materialien), 9 duale Systeme verglichen (PreZero Marktführer 2026, Lizenzero, Reclay, BellandVision, Interseroh+, Veolia, RKD, Zentek, ELS), Tarife 2026, Action-Plan + Kosten-Schätzung. Inkl. PPWR (8/2024) + EWKFondsG-Warnung.", status: "beta", route: "/cockpit/lucid-wizard" },
