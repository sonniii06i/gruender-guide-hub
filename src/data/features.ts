...
const _CATEGORIES_RAW: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { slug: "labor-vergleich", title: "Labor-Anbieter-Vergleich", desc: "21 akkreditierte Labore DE/EU (DAkkS ISO 17025) für Kosmetik/CPSR (Eurofins, BAV, Dermatest, SGS proderm, Cosmacon, IMQ), Lebensmittel/Supplement/Pet-Food (AGROLAB, Tentamus, Romer Labs, GBA), Electronics/RoHS/Funk (SGS, TÜV SÜD, TÜV Rheinland, DEKRA, cetecom, Phoenix Testlab, Element), Spielzeug (EN 71), Textil (Hohenstein OEKO-TEX, Testex). Inkl. 6 Use-Case-Stacks mit Kosten-Ballparks (Skincare 3,5-7,5k€ · Supplement 1,2-3k€ · FBA-Electronics 15-30k€ · Pet-Food 1,5-3,5k€), Preisliste pro Test-Typ + AVOID-Block.", status: "beta", route: "/cockpit/labor-vergleich" },
