...
const _CATEGORIES_RAW: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { slug: "fse-wizard", title: "FsE Erklär-Begleiter (Fragebogen steuerliche Erfassung)", desc: "Read-only Walkthrough: alle ~39 Felder des ELSTER-FsE in 10 Sektionen, nummeriert in ELSTER-Reihenfolge mit Erklärung was zu beantworten ist. Für die 4 binding-critical Entscheidungen (KU §19, EÜR/Bilanz, Soll/Ist, USt-IdNr) interaktive Mini-Empfehlungs-Widgets. Du füllst direkt in ELSTER aus, diese Seite liest parallel.", status: "beta", route: "/cockpit/fse-wizard" },
