...
const _CATEGORIES_RAW: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { slug: "bwa", title: "BWA-Generator (Bank-tauglich)", desc: "Bank-feste 5-Sektionen-BWA: Management-Summary, Kennzahlen-Dashboard mit Ampeln (EBITDA-Marge, EK-Quote, DSCR, Zinsdeckung), YoY-Vergleich, Bilanz-Struktur. Bank-Score 0-100 mit BBB-Rating-Schwellen.", status: "beta", route: "/cockpit/bwa-generator" },
