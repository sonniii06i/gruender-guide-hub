...
const _CATEGORIES_RAW: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { slug: "fse-wizard", title: "FsE-Wizard (Fragebogen steuerliche Erfassung)", desc: "Spickzettel-Generator für den ELSTER-FsE: alle Pflicht-Entscheidungen in der Reihenfolge wie ELSTER sie abfragt — Steuer-ID, KU §19 vs. Regel (5-Jahres-Bindung!), EÜR vs. Bilanz, Soll vs. Ist, USt-ID parallel. Pre-Fill aus GewA1-Wizard, druckbare PDF zum Abschreiben.", status: "beta", route: "/cockpit/fse-wizard" },
