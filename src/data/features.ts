...
const _CATEGORIES_RAW: FeatureCategory[] = [
  {
    ...
    features: [
      { slug: "us-llc-wizard", title: "US-LLC Setup-Wizard", desc: "10-Step-Wizard (Stand Mai 2026): Use-Case → Bundesstaat (WY/DE/NM/FL/NV) → LLC-Name → Registered Agent → Articles of Organization → Operating Agreement → EIN → BOI-Status (NICHT MEHR PFLICHT seit 26.3.2025!) → W-8BEN-E → Bank + Compliance (Form 5472 $25k-Falle!). Mit Cost-Calculator + IRS-International-Line +1-267-941-1099.", status: "beta", route: "/cockpit/us-llc-wizard" },
      { slug: "hk-limited-wizard", title: "HK-Limited Setup-Wizard", desc: "11-Step-Wizard (Stand Mai 2026): Use-Case → Director/Shareholder → Name → Company Secretary → Office → Share Capital → NNC1+BR → SCR (Pflicht seit 2018) → Profits Tax + FSIE (2023-Reform!) → Bank (kritisch — 40-60% HSBC-Ablehnungs-Quote) → Audit + Annual Returns. Two-Tier 8,25%/16,5%.", status: "beta", route: "/cockpit/hk-limited-wizard" },
      { slug: "us-hk-banking", title: "US + HK Banking + Closure-Risk-Vergleich", desc: "9 Anbieter (Stand Mai 2026): Wise Personal (€0!) + Wise Business + Mercury (Treasury 4,97%) + Relay + Brex (NICHT für Solo!) + Statrys + Airwallex + Currenxie + HSBC HK. Mit Trustpilot-Werten, Closure-Risk-Score (Brex very_high, Airwallex high), Reddit-Quotes, Hidden-Fees, 12 Survival-Tipps + Compliance-Updates (BOI tot, Mercury OCC-Charter, Capital-One+Brex Übernahme).", status: "beta", route: "/cockpit/intl-banking" },
      ...
      { slug: "abschreibung", title: "Abschreibungs-Rechner + Steuer-Ersparnis", desc: "Einzel-Rechner + Asset-Cart für mehrere Anschaffungen. Brutto/Netto-Toggle (Kassenbeleg-Modus). Steuer-Ersparnis-Berechnung (GmbH 30% vs ESt 14-47,5%). Liquiditäts-Effekt mit USt-VSt. SKR03/04-Buchungssatz-Hint. 18 Asset-Types: BMF-Sofortabschreibung Computer/Software (1 Jahr), GWG ≤800€ (§6 Abs. 2), Sammelposten 250-1000€ (§6 Abs. 2a, 5J), Lineare AfA §7 (Schreibtisch 13J, PKW 6J etc.).", status: "beta", route: "/cockpit/abschreibung" },
    ],
  },
  {
    slug: "steuer",
  ...
  },
  {
    ...
    features: [
      { slug: "ecom-roadmap", title: "ECom-Brand-Roadmap", desc: "8 Kategorien (Beauty, Supplement, Electronics, Toys, Apparel, Food, Pet, Hardware) mit DE/EU/US-Compliance 2026: GPSR (13.12.2024 ↑), Battery-Reg, EUDR, PFAS-Bans (Maine 1.1.2026), PPWR, EWKFondsG, Machinery-Reg 2027, MoCRA. Standard-Stack + Stolperfallen + Tool-Verlinkung.", status: "beta", route: "/cockpit/ecom-roadmap" },
      { slug: "lucid-wizard", title: "Verpackungslizenz-Rechner (LUCID)", desc: "5-Step-Wizard MIT KOSTEN-RECHNER (kein Verzeichnis!): (1) Pflicht-Check, (2) Firmen-Daten-Vorbereitung, (3) Material-Mengen-Eingabe (6 Materialien in kg/Jahr) → schätzt deine jährliche Lizenz-Kostenrange Low/Mid/High basierend auf Tarifen 2026 (+9-24% vs 2025), (4) Anbieter-Empfehlung aus 9 dualen Systemen (PreZero Marktführer, Lizenzero, Reclay, BellandVision, Interseroh+, Veolia, RKD, Zentek, ELS), (5) Action-Plan für die eigentliche LUCID-Eintragung bei ZSVR (machst du selbst auf verpackungsregister.org). Inkl. PPWR (8/2024) + EWKFondsG-Warnung + Mehrweg-Pflicht §33 + §7c-Marketplace-Haftung.", status: "beta", route: "/cockpit/lucid-wizard" },
      { slug: "ce-rohs", title: "CE/RoHS-Konformitätserklärung", desc: "PDF-Generator für 8 Produkt-Kategorien (Elektronik, Spielzeug, Maschine, Medizinprodukt, Kosmetik, PSA, Funk, Wearable) mit relevanten EU-Richtlinien + RoHS-Erklärung. Querschnitt-Warnung: GPSR 2023/988, Battery-Reg 2023/1542, Machinery-Reg 2023/1230 (gilt ab 14.01.2027), MDR 2017/745, AI-Act 2024/1689.", status: "beta", route: "/cockpit/ce-generator" },
      { slug: "labor-vergleich", title: "Labor-Anbieter-Vergleich", desc: "44 etablierte Labore DE/EU (DAkkS ISO 17025 · älteste seit 1828) für 14 Kategorien: Kosmetik/CPSR (Eurofins, BAV, Dermatest, SGS proderm, Dr. Schrader, Cosmacon, IMQ), Lebensmittel/Supplement/Pet-Food (AGROLAB, Tentamus, Romer Labs, GALAB, GBA, Mérieux, Kirchhoff Berlin, ISEGA, Currenta, Fraunhofer IVV), Electronics/RoHS/CE/Funk (SGS, TÜV SÜD/Rheinland/Nord, VDE, UL Solutions, DEKRA, cetecom, 7layers, Nemko, Eurofins E&E, Phoenix Testlab, Element, EMC Test NRW), Spielzeug/Konsumgüter (Hansecontrol, SATRA, Bureau Veritas), Textil/Leder (Hohenstein, Testex, CTC, Centexbel), Medizinprodukte MDR (MDC NB 0483, BSI 2797), PSA (DGUV Test, Kiwa), PFAS-Spezialisten. Inkl. 8 Use-Case-Stacks mit Kosten-Ballparks (Skincare 3,5-7,5k€ · Supplement 1,2-3k€ · FBA-Electronics 15-30k€ · Pet-Food 1,5-3,5k€ · MDR 30-300k€ · PSA 3-25k€), 30-Eintrag-Preisliste + AVOID-Block.", status: "beta", route: "/cockpit/labor-vergleich" },
      { slug: "visa-helper", title: "Visa-Helper international (beide Richtungen)", desc: "🇩🇪 NACH Deutschland: 6 Aufenthaltstitel mit Profil-Score (§21/§18g/§18a/b/§20a/§28/§30). 🌍 AUS Deutschland raus: 27 Visa weltweit (USA O-1/EB-2/E-2/L-1, UK Innovator+Global Talent, PT D7/D2/Golden, ES DNV+Beckham, EE Startup, UAE Golden, SG Tech.Pass, TH LTR, Georgien 1% etc.). Inkl. §6 AStG Wegzugsbesteuerung-Block + AVOID-Liste (DE HAT E-2-Treaty mit USA — Mythos widerlegt!).", status: "beta", route: "/cockpit/visa-helper" },
      { slug: "foerderung-db", title: "Förderung-Datenbank international", desc: "40+ Programme in 14 Ländern: 🇩🇪 KfW/EXIST/HTGF/INVEST/Bundesländer · 🇪🇺 EIC Accelerator (€2,5M+€15M Equity), Eurostars-3, Innovation Fund · 🇫🇷 BPI/CIR/JEI · 🇳🇱 WBSO+Innovatiekrediet · 🇮🇱 IIA · 🇺🇸 YC ($500k), Techstars ($220k), MassChallenge, SBIR · 🇬🇧 SEIS/EIS (50%/30%), R&D Relief · 🇨🇭 Innosuisse, Venture Kick CHF 150k · 🇸🇬 SEEDS Capital · 🇳🇴 NUF · 🌍 Antler Berlin €500k. Filter nach Land/Typ/Phase mit Watchouts.", status: "beta", route: "/cockpit/foerderung" },
    ],
  },
  {
    slug: "marken",
