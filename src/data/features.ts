...
const _CATEGORIES_RAW: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { slug: "us-kreditkarten", title: "US-Kreditkarten + Miles-Strategien", desc: "23 Karten + 15 Miles-Sweet-Spots + DE→US Amex-MR-Transfer-Hack (~17% FX-Bonus) + Velocity-Strategie (€8-12k SUB/Jahr).", status: "beta", route: "/cockpit/us-kreditkarten" },
  ...
  },
  {
    ...
    features: [
      { slug: "ecom-roadmap", title: "ECom-Brand-Roadmap", desc: "8 Kategorien (Beauty/Supplement/Electronics/Toys/Apparel/Food/Pet/Hardware) mit DE/EU/US-Compliance-Stack 2026. Stolperfallen + Tool-Verlinkung.", status: "beta", route: "/cockpit/ecom-roadmap" },
      ...
      { slug: "ce-rohs", title: "CE/RoHS-Konformitätserklärung", desc: "PDF-Generator für 8 Produkt-Kategorien (Elektronik/Spielzeug/Maschine/Medizinprodukt/Kosmetik/PSA/Funk/Wearable) mit GPSR + Battery-Reg + Machinery 2027.", status: "beta", route: "/cockpit/ce-generator" },
