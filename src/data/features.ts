...
const _CATEGORIES_RAW: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { slug: "fse-kapitalgesellschaft", title: "FsE Kapitalgesellschaft (GmbH/UG/AG/eG)", desc: "Walkthrough aller 23 Teilseiten des echten ELSTER-FsE für Kapitalgesellschaften (Stand 2026), in ELSTER-Reihenfolge mit Zeilennummern: Stammkapital, Anteilseigner, Sach-/Bargründung, Organschaft, Soll-/Istversteuerung, USt-IdNr, OSS. Du füllst in ELSTER aus, diese Seite erklärt parallel.", status: "beta", route: "/cockpit/fse-kapitalgesellschaft" },
      { slug: "fse-personengesellschaft", title: "FsE Personengesellschaft (GbR/OHG/KG)", desc: "Walkthrough aller 22 Teilseiten des echten ELSTER-FsE für Personengesellschaften (Stand 2026), in ELSTER-Reihenfolge mit Zeilennummern: Vertretung, Beteiligte + Gewinnanteile (gesonderte+einheitliche Feststellung), Gewinnermittlung, USt/KU §19, USt-IdNr, OSS. Du füllst in ELSTER aus, diese Seite erklärt parallel.", status: "beta", route: "/cockpit/fse-personengesellschaft" },
  ...
  },
  {
    ...
    features: [
      ...
      { slug: "us-tax-helper", title: "US-Tax-Helper (welche Abgaben?)", desc: "Setup wählen (SMLLC/Partnership/C-Corp/US-Person) → alle Pflicht-Filings IRS + State: Form 5472, 1120, 1065, 1040-NR, W-8BEN-E mit Fristen, $25k-Falle, BOI-Entwarnung 2025 + Formular-Downloads + PDF-Checkliste.", status: "beta", route: "/cockpit/us-tax-helper" },
      { slug: "hk-tax-helper", title: "HK-Tax-Helper (welche Abgaben?)", desc: "Setup wählen (Ltd./Sole/Partnership) → alle IRD-Filings: Profits Tax Return (BIR51/52/54), Employer's Return, Audit-Pflicht, BR-Renewal, NAR1. Fristen per N/D/M-Code + Formular-Quellen + PDF-Checkliste.", status: "beta", route: "/cockpit/hk-tax-helper" },
  ...
  },
  {
    ...
    features: [
      ...
      { slug: "shop-profit-rechner", title: "Shop-Profit-Rechner (eigener Shop)", desc: "EK brutto rein, VK brutto rein — Vorsteuer und USt werden herausgerechnet, dann Versand, PayPal-Gebühren (2,49 % + 0,35 €, ohne Vorsteuer) und Klickkosten je Bestellung gegengerechnet. Mit Break-even: wie viele Klicks eine Bestellung trägt und welche Conversion-Rate sie braucht.", status: "beta", route: "/cockpit/shop-profit-rechner" },
