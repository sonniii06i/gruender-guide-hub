...
export const EU_ALTERNATIVES: EUAlternative[] = [
  ...
  // ============================================================
  {
    ...
    minCapital: 12000,
    capitalPaidUp: "12.000 € (S.à r.l.) bzw. 30.000 € (S.A.) zu 100 %",
    corporateTax: "24,94 % (KSt 17 % + Soli 7 % + Gewerbe 6,75 % Stadt Luxemburg)",
    localTax: "Gewerbesteuer kommunal (LU-City: 6,75 %)",
    effectiveTotal: "0 % auf qualifizierte Beteiligungs-Erträge (100 % Befreiung) · 24,94 % auf Op-Gewinn",
  ...
  // ============================================================
  {
    ...
    corporateTax: "15 % regulär · 5 % bei Small Companies (Umsatz < 300k €/Jahr + < 10 MA)",
    localTax: "0 %",
    effectiveTotal: "5 % (Small) bzw. 15 %",
    withholdingDividends: "15 % regulär · 0 % via EU-Mutter-Tochter",
    motherDaughterApplies: true,
    ...
    bestFor: [
      ...
      "Klein-Companies < 300k Umsatz (5 % KSt!)",
    ...
    pros: [
      "**5 % KSt für Small** (Umsatz < 300 k + < 10 MA) — sehr attraktiv für Bootstrap-Startups",
    ...
    cons: [
      "Bei > 300 k Umsatz: Sprung von 5 % auf 15 %",
