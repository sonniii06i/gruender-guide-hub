...
export const PLAYBOOKS: Playbook[] = [
  ...
  // ============================================================
  {
    ...
    steps: [
      ...
      {
        slug: "welcome-flow",
        title: "Welcome-Flow (Sign-Up → Erst-Käufer)",
        description: "Erste Email-Sequenz nach Newsletter-Anmeldung: Brand-Story + Produkt-Empfehlung + Discount → Conversion in Erstkäufer.",
        kind: "checklist",
        estMinutes: 240,
        estCost: "DIY 0 € · Email-Designer 200-1.500 € für 5-7 Mails",
        checklist: [
          "Email 1 (sofort): Welcome + Discount-Code 10-15 % + Brand-Story (Conversion-Email)",
          "Email 2 (+1 Tag): Best-Seller-Empfehlung + Customer-Reviews",
          "Email 3 (+3 Tage): Brand-Mission + Founder-Story (Trust-Email)",
          "Email 4 (+5 Tage): Erinnerung Discount-Code (läuft bald ab)",
          "Email 5 (+7 Tage): Anwendungs-Tipps + UGC (Lifestyle-Email)",
          "Email 6 (+14 Tage): Letzter Reminder + Bundle-Angebot",
          "Email 7 (+21 Tage): Newsletter-Übergang (regelmäßiger Content)",
          "Discount-Code-Generator pro Kunde (1-time-Use, Tracking)",
          "Mobile-First Design (60-70 % Email-Öffnungen mobil)",
          "DSGVO-Footer in jeder Mail: Abmelde-Link + Impressum + DSGVO-Hinweis",
        ],
        extendedNotes: [
          "Welcome-Flow Branchen-Standard-Performance: 25-35 % Open-Rate, 4-8 % Click-Rate, 5-15 % Sign-Up-to-Purchase-Conversion.",
          "Email 1 (Welcome+Discount) macht 60-80 % der Welcome-Flow-Sales. Hier am meisten Zeit investieren.",
        ],
      },
      {
        slug: "cart-recovery",
  ...
  // ============================================================
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Standard-Pixel (browser-based) + CAPI (server-side) DUAL-tracking. Notwendig seit iOS 14.5 (ATT) — Pixel allein verliert 30-60 % der Conversions.",
        kind: "external",
        estMinutes: 240,
        estCost: "DIY 0 € · Shopify Meta-App 0 € (CAPI inkl.) · sGTM-Hosting 30-100 €/Mon · Custom-Implementation 1.500-5.000 €",
        externalLinks: [
          { label: "Meta Pixel + CAPI Setup", url: "https://www.facebook.com/business/help/952192354843755" },
          { label: "Server-Side Google Tag Manager", url: "https://developers.google.com/tag-platform/tag-manager/server-side" },
          { label: "Shopify Meta-App", url: "https://apps.shopify.com/facebook" },
        ],
        checklist: [
          "Pixel-ID generieren in Meta Business Manager",
          "Pixel-Code in Shopify/WordPress/Custom installieren (alle Seiten)",
          "Standard-Events: PageView, ViewContent, AddToCart, InitiateCheckout, Purchase",
          "Custom-Events für Funnel-Schritte (Newsletter-Sign-Up, Pre-Order, etc.)",
          "Conversions API (CAPI) konfigurieren — Server-Side-Tracking",
          "CAPI-Implementierung: Shopify nativ ODER GTM Server-Side-Tag (sGTM) ODER Custom-API",
          "Event Match Quality (EMQ) > 6.0 anstreben (Email + Phone + IP + UA)",
          "Domain-Verifizierung in Business-Manager",
          "Aggregated Event Measurement: max 8 Events pro Domain priorisieren",
          "Test-Events-Tool nutzen für Verification",
        ],
        extendedNotes: [
          "ATT-Effekt (iOS 14.5+): browser-Only-Pixel verliert 30-60 % iOS-Conversions. CAPI sendet Events direkt von Server an Meta — umgeht ATT teilweise.",
          "EMQ-Score-Boost: Hashed Email/Phone/IP an CAPI senden → höherer Match → bessere Targeting/Attribution.",
          "sGTM-Hosting bei Stape (~30 €/Mon) oder Eigenbetrieb auf GCP (~50 €/Mon, mehr Kontrolle).",
        ],
      },
      {
        slug: "tiktok-pixel",
      ...
      {
        slug: "ga4-tracking",
        title: "Google Analytics 4 (GA4) + Server-Side Tracking",
        description: "GA4 für End-to-End-Tracking + Quellen-Attribution + Cross-Device. Server-Side-GTM (sGTM) ist Best Practice für Performance + Datenschutz.",
        kind: "external",
        estMinutes: 240,
        estCost: "GA4 0 € (gratis) · sGTM 30-100 €/Mon (Stape/eigenes Setup) · GA4 360 ab 50k €/Jahr (nur Enterprise)",
        externalLinks: [
        ...
        checklist: [
          "GA4 Property + Data Stream einrichten",
          "Enhanced Ecommerce-Events: view_item, add_to_cart, begin_checkout, purchase",
          "GTM Container (Web-Side) installieren",
          "GTM Server-Side Container in Stape oder eigenes GCP-Setup",
          "Cross-Domain-Tracking (Shopify Checkout → eigene Domain)",
          "Custom-Events für eigene Conversion-Steps",
          "Audience-Definitionen für Remarketing (z.B. 'Cart Abandoners 24h')",
          "Looker Studio Dashboard für Reports (gratis)",
          "Data-Retention auf 14 Monate setzen (Standard ist 2 Monate)",
          "Consent-Mode v2 implementieren (DSGVO-Compliance)",
        ],
        extendedNotes: [
          "GA4 vs UA (Universal Analytics): UA wurde 1.7.2023 deaktiviert. GA4 hat steile Lernkurve aber bessere Cross-Device + Privacy-Features.",
          "sGTM-Vorteile: First-Party-Cookies, weniger Ad-Blocker-Verluste, höhere Datenqualität, mehr Kontrolle über PII.",
        ],
      },
      {
