...
export const PLAYBOOKS: Playbook[] = [
  ...
  // ============================================================
  {
    ...
    steps: [
      ...
      {
        slug: "warenwirtschaft-billbee",
        title: "Warenwirtschaft wählen + Billbee einrichten",
        description: "Eine Warenwirtschaft (Wawi) zentralisiert Bestand, Bestellungen, Rechnungen und Versand-Labels über alle Marketplaces. Billbee ist für 95 % der Reseller-Starts die richtige Wahl.",
        kind: "external",
        estMinutes: 120,
        estCost: "Billbee 9-39 €/Mon · Plenty/Xentral/JTL 50-500 €/Mon",
        externalLinks: [
          { label: "Billbee (Standard-Wahl)", url: "https://www.billbee.io" },
          { label: "Billbee Onboarding-Guide", url: "https://help.billbee.io/de/" },
          { label: "plentymarkets (ab 1k+ Orders/Mon)", url: "https://www.plentymarkets.com" },
          { label: "Xentral ERP", url: "https://xentral.com" },
          { label: "JTL-Wawi (kostenlos Basis)", url: "https://www.jtl-software.de" },
        ],
        checklist: [
          "Tool wählen: Billbee ab 9 €/Mon — bis ~1k Orders/Mon richtig",
          "Plenty / Xentral / JTL erst ab Mid-Market (>1k Orders, komplexes Setup)",
          "Billbee-Account anlegen + Trial starten",
          "Marketplace-Connections schalten (Amazon, eBay, Kaufland)",
          "Mit 5-10 Test-SKUs Bestand-Sync prüfen vor Voll-Roll-out",
          "Auto-Workflow: Bestellung → Rechnung → Versand-Label triggern",
        ],
      },
      {
