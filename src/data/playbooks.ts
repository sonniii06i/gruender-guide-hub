...
export const PLAYBOOKS: Playbook[] = [
  ...
  // ============================================================
  {
    ...
    steps: [
      ...
      {
        slug: "warenwirtschaft-repricing",
        title: "Warenwirtschaft + Repricing-Stack",
        description: "Reseller skaliert nur mit Tooling. Warenwirtschaft + Repricer sind Pflicht ab 100 SKUs.",
        kind: "external",
        estMinutes: 240,
        estCost: "Warenwirtschaft 50-500 €/Mon · Repricer 50-300 €/Mon",
        externalLinks: [
          { label: "Billbee (DACH-KMU-Standard)", url: "https://www.billbee.io" },
          { label: "plentymarkets", url: "https://www.plentymarkets.com" },
          { label: "Xentral ERP", url: "https://xentral.com" },
          { label: "JTL-Wawi", url: "https://www.jtl-software.de" },
          { label: "Sellerlogic Repricer", url: "https://www.sellerlogic.com" },
          { label: "BQool Repricer", url: "https://www.bqool.com" },
          { label: "RepricerExpress", url: "https://repricerexpress.com" },
          { label: "Sendcloud (Versand)", url: "https://www.sendcloud.de" },
          { label: "Shipcloud (Versand)", url: "https://www.shipcloud.io" },
          { label: "ZenFulfillment (Prep-Center DACH)", url: "https://www.zenfulfillment.com" },
          { label: "Prep-Center Germany", url: "https://prep-center-germany.com" },
        ],
        checklist: [
          "Warenwirtschaft-Wahl je Volumen: Billbee (Solo/KMU, ab 9 €/Mon, einfach), plentymarkets (DACH-Mid-Market), Xentral (modern, API-first), JTL-Wawi (KMU-Standard, kostenlos in Basis)",
          "Multi-Channel-Sync: Bestand zwischen Amazon/eBay/Kaufland zentral verwaltet (alle 4 Tools können das)",
          "Repricer-Vergleich für Amazon: Sellerlogic (DACH-Standard, regelbasiert), BQool (KI-basiert, global Top-Tier), RepricerExpress (günstig, einfach). Sweet-Spot 50-300 €/Mon",
          "Versand-Integration: Sendcloud (DACH-Standard, 30+ Carrier), Shipcloud (DACH-Alternative), DHL Geschäftskunden-Portal direkt",
          "Prep-Center (3PL für FBA-Vorbereitung): ZenFulfillment, Prep-Center Germany, FBA-Prep-Service.com — kümmern sich um Wareneingang aus China, FBA-Label, Bundling, Polybag, Versand an Amazon-Lager. Pflicht bei Import-Reseller-Modell + Pan-EU-FBA",
          "Prep-Center vs. Self-Prep: Prep-Center 1-3 € pro Unit, Self-Prep günstiger aber Founder-Bottleneck — ab 500 Units/Monat outsourcen",
          "Returns-Workflow: Marketplace-Returns + Restocking + Refurbishment (Prep-Center übernimmt oft auch Retouren-Inspection)",
        ],
      },
      {
