  ...
  // ============================================================
  {
    ...
    steps: [
      ...
      },
      {
        ...
        checklist: [
          "Warenwirtschaft-Wahl: plentymarkets (DACH-Standard), Xentral (modern), JTL (KMU-Standard)",
          "Multi-Channel-Sync: Bestand zwischen Amazon/eBay/Kaufland zentral verwaltet",
          "Repricer für Amazon: Sellerlogic, RepricerExpress (Buy-Box-Algorithmus mit Min-/Max-Preis)",
          "Versand-Integration: Sendcloud / Shipcloud / DHL Geschäftskunden-Portal",
          "Returns-Workflow: Marketplace-Returns + Restocking + Refurbishment",
        ],
      },
      {
