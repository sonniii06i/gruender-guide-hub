...
export const BIZ_CARDS: BizCard[] = [
  ...
  },
  {
    ...
    hasFreeTier: true,
    paymentTerm: null,
    rewards: "0,4 % (Plus-Karte, max 180 €/J) bzw. 0,8 % (X-Karte, max 360 €/J) Cashback",
    signupBonus: null,
    datevNative: true,
  ...
  },
  {
    ...
    paymentTerm: null,
    rewards:
      "0,1 % / 0,2 % / 0,5 % Cashback (Start/Basic/Pro) + Marketing-Cashback bis ~10 % auf Meta/Google/Amazon Ads",
  ...
  // ===== TEAM / SPEND-MANAGEMENT =====
  {
    ...
    network: "Mastercard",
    annualEur: 0,
    priceLabel: "0 / 35 / 79 € pro Monat (jährlich)",
    hasFreeTier: true,
    paymentTerm: null,
  ...
  },
  {
    ...
    rewards: "1 Membership-Rewards-Punkt / 1 € Umsatz",
    signupBonus: "50.000 MR-Punkte bei 10.000 € in 6 Mon. + 100 € Dell-Guthaben (Aktion, variiert)",
    datevNative: false,
    fxFee: "2,5 %",
    schufa: true,
    soloDayOne: false,
  ...
  // ===== INTERNATIONAL / MULTI-WÄHRUNG =====
  {
    ...
    network: "Mastercard",
    annualEur: 0,
    priceLabel: "kein Abo · 45 € Einrichtungsgebühr einmalig",
    hasFreeTier: true,
    paymentTerm: null,
    rewards: "kein Cashback",
    signupBonus: null,
    datevNative: false,
    fxFee: "ab 0,47 % pro Umtausch, echter Mittelkurs",
    schufa: false,
    soloDayOne: true,
    ...
    insurance: null,
    bestFor: "★ Bestes FX/Multi-Währung (ab 0,47 %) — international",
    watchouts: [
