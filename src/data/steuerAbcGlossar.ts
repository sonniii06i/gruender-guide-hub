...
export const GLOSSAR: GlossarBegriff[] = [
  ...
  { begriff: "Solidaritätszuschlag (SolZ)", aliases: ["SolZ", "Soli"], kategorie: "grundbegriffe",
    kurzDefinition: "5,5 % Zuschlag auf ESt + KSt. Bei ESt: Freigrenze bis 20.350 €/J festgesetzte ESt (Single, 2026).",
    ausfuehrlich: "Seit 2021 für 90 % der Steuerzahler abgeschafft (Freigrenze 2026: 20.350 € ESt für Single, 40.700 € verheiratet; 2025: 19.950 € / 39.900 €). Bei KSt: KEINE Freigrenze — fällt immer voll an.",
    paragraph: "SolZG",
  },
  ...
  { begriff: "Grenzsteuersatz", aliases: ["Grenzsteuersatz", "Spitzensatz"], kategorie: "grundbegriffe",
    ...
    ausfuehrlich: "Wichtig für Spar-Strategien (z.B. IAB, Sonderausgaben): jeder zusätzlich abgesetzte Euro wird mit dem Grenzsteuersatz gespart, nicht mit dem Durchschnitt. Bei 80k Gewinn: Durchschnittssatz ~28 %, aber Grenzsteuersatz schon 42 % (Spitzensatz ab 69.879 € zvE, 2026).",
  ...
  { begriff: "KSK (Künstlersozialkasse)", aliases: ["KSK", "Künstlersozial"], kategorie: "sv-kv",
    kurzDefinition: "Spezielle Sozial-Versicherung für selbständige Künstler/Publizisten — Versicherter trägt ~50 % selbst, die andere Hälfte läuft über die KSK (30 % Künstlersozialabgabe + 20 % Bundeszuschuss).",
    ausfuehrlich: "Pflichtmitgliedschaft für: Maler, Musiker, Schauspieler, Autoren, Journalisten, Fotografen, Designer (wenn freiberuflich + überwiegend selbstständig). Mindesteinkommen 3.900 €/Jahr (sonst Befreiung). Auftraggeber zahlen KSK-Abgabe (4,9 % 2026, vorher 5,0 %) auf gezahlte Honorare; Bagatellgrenze 1.000 €/Jahr (2025: 700 €).",
    paragraph: "KSVG",
  },
  { begriff: "BBG (Beitragsbemessungsgrenze)", aliases: ["BBG"], kategorie: "sv-kv",
    kurzDefinition: "Höchstgrenze für SV-Beiträge. BBG-RV 2026: 101.400 €/J (bundeseinheitlich). BBG-KV/PV 2026: 69.750 €/J (5.812,50 €/Mon).",
  ...
  { begriff: "Familienversicherung", aliases: ["Familienvers"], kategorie: "sv-kv",
    ...
    ausfuehrlich: "Ehepartner: kostenlos mitversichert wenn Gesamteinkommen ≤ 565 €/Monat (2026; bei Minijob 603 €/Monat — wird jährlich angepasst). Kinder: bis 23 J. (mit Schule/Studium bis 25). Bei Selbstständigkeit/höherem Einkommen: eigene Versicherung Pflicht.",
    paragraph: "§10 SGB V",
  },
  ...
  { begriff: "Betriebsprüfung", aliases: ["Außenprüfung", "BP"], kategorie: "fa-verfahren",
    ...
    ausfuehrlich: "Bei Klein-/Mittel: alle 3-7 Jahre. Bei Groß-Unternehmen: laufend (Anschluss-BP). Prüfungs-Schwerpunkte: USt, Personalkosten, Geschäftsführer-Gehalt, Verrechnungspreise. Bei Verstößen: Nachforderung + Nachzahlungszinsen (§ 233a i. V. m. § 238 Abs. 1a AO: 0,15 %/Monat = 1,8 %/Jahr seit 2019) + ggf. Strafverfahren.",
    paragraph: "§§ 193 ff. AO",
  },
