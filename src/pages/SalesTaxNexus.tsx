...
const US_STATES: StateNexus[] = [
  ...
  { code: "UT", name: "Utah", salesThreshold: 100000, logic: "salesOnly", stateRate: 6.1, combinedAvg: 7.42, marketplaceFacilitator: true, notes: "Txn-Schwelle weg seit 1.7.2025. Rate von 4,85% auf 6,10% korrigiert." },
