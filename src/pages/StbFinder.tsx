...
const SPEZIALISIERUNGEN: Spezialisierung[] = [
  ...
  },
  {
    ...
    emoji: "🏗️",
    desc: "Reguläre Gründungs-Begleitung. Notar-Termin, Eröffnungs-Bilanz, Gewerbeanmeldung, Frage 'Bilanzierung oder EÜR'.",
    pflicht: [
      "Eröffnungsbilanz / EÜR-Wahlrecht",
      "USt-Voranmeldung-Frequenz (Monatlich vs. Quartalsweise)",
      "Lohnabrechnung GF + Mitarbeiter",
      "Jahres-Abschluss Bilanz/Anhang/Lagebericht (je nach Größe)",
      "GewSt + KSt + USt-Erklärung",
    ],
    bonus: [
      "Existenzgründer-Begleitung mit IHK",
      "EXIST/KfW-Förderung-Anträge",
      "DATEV-Workflow von Anfang sauber",
      "Crypto-Knowledge falls Side-Themen",
    ],
    honorarJahr: "1.500-5.000 € / Jahr (Einzel-EÜR bis kleine GmbH)",
    erstterminFragen: [
      "Welche Buchhaltungs-Software empfehlen Sie? (DATEV ja oder nein, je nach Größe)",
      "Was kostet das Eröffnungsbilanz-Setup einmalig?",
      "Wer bucht: ich, Ihr Büro, oder gemischt?",
      "Was kostet ein Standard-Jahresabschluss exakt?",
      "Wie schnell antworten Sie auf Email — gleicher Tag, 24h, 48h?",
    ],
    redFlags: [
      ...
      "Honorar-Bandbreiten ohne Mengen-Bezug",
      "Kein klarer Workflow für USt-Voranmeldung",
    ],
    wofindet: [
      "Steuerberaterkammer-Suche",
      "Local IHK Empfehlung",
      "Reddit r/dachgewerbe",
      "Lexoffice / sevDesk Partner-Liste",
    ],
  },
];
