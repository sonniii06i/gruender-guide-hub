...
const UstVoranmeldung = lazy(() => import("./pages/UstVoranmeldung.tsx"));
...
const UsTaxHelper = lazy(() => import("./pages/UsTaxHelper.tsx"));
const HkTaxHelper = lazy(() => import("./pages/HkTaxHelper.tsx"));
...
const AmazonErstattungen = lazy(() => import("./pages/AmazonErstattungen.tsx"));
          ...
          <Suspense fallback={<PageFallback />}>
            <Routes>
              ...
              <Route element={<AppLayout />}>
                ...
                <Route path="/cockpit/ust-voranmeldung" element={<PaywallGate title="USt-Voranmeldung"><UstVoranmeldung /></PaywallGate>} />
                ...
                <Route path="/cockpit/us-tax-helper" element={<PaywallGate title="US-Tax-Helper"><UsTaxHelper /></PaywallGate>} />
                <Route path="/cockpit/hk-tax-helper" element={<PaywallGate title="HK-Tax-Helper"><HkTaxHelper /></PaywallGate>} />
                ...
                <Route path="/cockpit/amazon-erstattungen" element={<PaywallGate title="Amazon Erstattungen & Seller-Automation"><AmazonErstattungen /></PaywallGate>} />
