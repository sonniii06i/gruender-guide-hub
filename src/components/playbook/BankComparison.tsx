...
const BANKS: Bank[] = [
  // ============ HAUSBANKEN (Filialnetz, Kreditbeziehung) ============
  {
    ...
    monthlyFee: "ab 14,90 €/Mon.",
    txnCost: "0,30 € (online), beleghaft 1,50 €+",
  ...
  },
  {
    ...
    monthlyFee: "ab 15,90 €/Mon.",
    txnCost: "0,20 € online, ab 11. Buchung",
    freeTxns: "10 inkl.",
  ...
  },
  {
    ...
    txnCost: "0,28 € online, beleghaft mehr",
  ...
  // ============ DIREKTBANKEN / ONLINE-HYBRID ============
  {
    ...
    setupTime: "1–2 Wochen",
    rating: 4,
    pros: ["Sauberes Online-Banking", "Unbegrenzte beleglose Buchungen (im Tarif)", "Kostenlose Karte (in Tarif)"],
    cons: ["Keine Filiale", "GmbH & UG nicht zugelassen – nur Freiberufler/Selbstständige"],
    bestFor: "Freiberufler & Selbstständige ohne Cash-Geschäft",
  },
  {
    name: "Fyrst",
    type: "online",
  ...
  },
  {
    ...
    cons: ["Reviews wegen Account-Sperren gemischt", "Zusatzkosten über 500 SEPA/Mon."],
  ...
  },
  {
    ...
    cons: ["GmbH & UG generell nicht akzeptiert", "Account-Sperren-Stories in Reviews"],
    bestFor: "Solo-Selbstständige & Freiberufler (kein GmbH-Konto)",
  },
  {
    name: "Revolut Business",
    type: "neobank",
    url: "https://www.revolut.com/de-DE/business/",
    monthlyFee: "ab 10 €/Mon. (Basic)",
    txnCost: "0,20 € pro SEPA ab Limit",
    freeTxns: "10 lokale Zahlungen (Basic)",
  ...
  },
  {
    ...
    monthlyFee: "0 € (Standard) / ab 9,90 €/Mon.",
    txnCost: "0 € (unbegrenzt inkl.)",
    freeTxns: "unbegrenzt SEPA",
    card: "Visa Business Debit",
    stammkapital: "ja",
    gmbhIG: "ja",
