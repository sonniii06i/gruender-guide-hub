...
const BANKS: Bank[] = [
  ...
  },
  {
    ...
    monthlyFee: "Klassik ~12,90 €/Mon. · Premium Plus 54,90 €/Mon.",
    txnCost: "Klassik mit Buchungspaket, Premium Plus 0,10 € ab 251.",
    freeTxns: "Premium Plus: 250 inkl.",
  ...
  },
  {
    ...
    txnCost: "Lite mit Limit, Pro unlimited Buchungen",
    freeTxns: "Lite 100 SEPA · Pro unlimited",
  ...
  },
  {
    ...
    txnCost: "Solo 50 beleglos inkl., Start mehr · 0,20 € extra · +1 % ab 25k €/Mon",
    freeTxns: "Solo 50 SEPA · Start je Tarif",
