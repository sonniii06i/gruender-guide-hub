...
const BANKS: Bank[] = [
  ...
  },
  {
    ...
    monthlyFee: "Klassik 15,90 €/Mon. (12 Mon. gratis Neukunden) · Premium 34,90 €/Mon. · Premium Plus 54,90 €/Mon.",
    txnCost: "Klassik 0,20 € ab 11. · Premium 0,15 € ab 51. · Premium Plus 0,10 € ab 251.",
    freeTxns: "Klassik 10 · Premium 50 · Premium Plus 250 beleglose inkl.",
    ...
    cons: [
      "Premium Plus 54,90 €/Mon teurer als Komplett-Lösungen bei Qonto/Finom",
  ...
  },
  {
    ...
    monthlyFee: "Giro 12,90 € · aktiv 16,90 € · aktiv plus 24,90 €/Mon. (Promo bis 31.03.2027: 0 € Grundpreis)",
    txnCost: "0,28 € (Giro) · 0,22 € (aktiv) · 0,12 € (aktiv plus) beleglos; beleghaft 3,00 €",
    freeTxns: "Promo-Aktion bis 31.03.2027",
  ...
  },
  {
    ...
    monthlyFee: "Modul 50 (25 €/Mon.) · Modul 250 (50 €/Mon.) · Modul 750 (80 €/Mon.) · Modul 1.500 (130 €/Mon.)",
    txnCost: "0,40 € (Modul 50) · 0,30 € (250) · 0,20 € (750) · 0,10 € (1.500) ab Limit",
    freeTxns: "50/250/750/1.500 beleglose je Modul (monatlich wechselbar)",
  ...
  },
  {
    ...
    monthlyFee: "Plus 9,90 € · Komfort 14,90 € · Premium 26,90 €/Mon.",
    txnCost: "Plus 0,20 € · Komfort 0,15 € · Premium 0,10 € (je ab Limit)",
    freeTxns: "Plus 0 · Komfort 30 · Premium 75 beleglose inkl.",
    card: "Visa Business",
    stammkapital: "ja",
    gmbhIG: "ja",
    setupTime: "2–3 Wochen",
  ...
  },
  {
    ...
    monthlyFee: "Flex 0 € · Lite 9 €/Mon. (4,50 € Jahresabo) · Pro 15 €/Mon. (9 € Jahresabo)",
    txnCost: "Flex 0,25 €/Buchung · Lite 0,25 € ab 101. · Pro unlimited",
    freeTxns: "Flex 0 · Lite 100 SEPA · Pro unlimited",
  ...
  },
  {
    ...
    monthlyFee: "Solo 0 € (NICHT für GmbH) · Basic 10,99 €/Mon. (8,99 € Jahresabo, für GmbH/UG)",
    txnCost: "Solo 50 beleglos inkl., Basic 100 inkl. · 0,03 % ab 25k €/Mon. SEPA-Volumen",
    freeTxns: "Solo 50 SEPA · Basic 100 beleglose/Mon.",
    ...
    cons: [
      ...
      "1 %-Umsatzgebühr ab 25k €/Mon SEPA-Volumen unfair für skalierende D2C-Brands",
    ],
  ...
  },
  {
    ...
    rating: 3,
    dealbreaker: "N26 Business akzeptiert NUR Freiberufler/Selbstständige. N26 Small Business (GmbH/UG) ist Early-Access-Produkt mit Warteliste, ohne Preis und ohne Stammkapital-Support – für GmbH-Gründung weiterhin ungeeignet.",
    pros: [
  ...
  },
  {
    ...
    txnCost: "Basic 10 lokal; Grow 100 lokal + 5 international; Scale 1.000 lokal + 25 international",
  ...
  },
  {
    ...
    monthlyFee: "Free Start 0 € · Basic 6,90 € (8,90 € mtl.) · Pro 18,90 € (24,90 € mtl.) · Enterprise 79 €/Mon.",
    txnCost: "unbegrenzte SEPA gratis in allen Tarifen",
    freeTxns: "unbegrenzt (alle Tarife)",
  ...
  },
  {
    ...
    freeTxns: "Core 100 · Pro 250 · Elite 500 gebührenfrei PRO JAHR (danach 0,13 €/Buchung)",
    ...
    cons: [
      "Freivolumen PRO JAHR (Core 100, Pro 250, Elite 500) – bei 0,13 €/Buchung teuer für Active Booker",
  ...
  // ============ NACHHALTIGE BANKEN ============
  {
    ...
    monthlyFee: "10 €/Mon. + 5 € GLS-Beitrag (Pflicht, GmbH)",
    txnCost: "0,14 € online · beleghaft 1,00 €",
    freeTxns: "begrenzt",
    card: "Visa Business",
    stammkapital: "ja",
    gmbhIG: "ja",
  ...
  },
  {
    name: "Triodos Bank",
    type: "sustainable",
    url: "https://www.triodos.de/schliessung",
    monthlyFee: "12,50 €/Mon. (keine Neuanträge mehr)",
    txnCost: "0,14 € pro Buchung",
    freeTxns: "begrenzt",
    card: "Mastercard Business",
    stammkapital: "nein",
    gmbhIG: "nein",
    setupTime: "nicht verfügbar (kein Neukunden-Onboarding)",
    rating: 4,
    dealbreaker: "Triodos Bank verlässt Deutschland-Markt bis 2027 – keine Neuanträge für Geschäftskonten möglich. Bestehende Konten werden schrittweise gekündigt. Alternative: UmweltBank (exklusiver Triodos-Partner).",
    pros: ["Strikte ESG-Filter", "Transparente Mittelverwendung"],
    cons: ["Marktaustritt DE 2027 – keine Neukonten", "Feature-Set kleiner als Neobanks"],
    bestFor: "Impact-/Sustainability-Brands (NICHT für Neugründer – kein Neukunden-Onboarding)",
  },
  {
    ...
    cons: ["Solaris-Backend (BaFin-Bußgelder > 7 Mio. €) + Tomorrow 50 % Stellenabbau Jul 2025", "Limitierte Buchungspakete"],
