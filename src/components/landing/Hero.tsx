  ...
  return (
    <section className="relative bg-hero pt-36 pb-24 overflow-hidden">
      ...
      <div className="container max-w-6xl">
        <div className="grid lg:grid-cols-[1.15fr,0.85fr] gap-10 lg:gap-8 items-center">
          {/* Text-Spalte */}
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 text-balance">
              Rechtsform, Amazon-Business, Buchhaltung & Steuer, Marke – Felix führt dich als
              KI-Co-Pilot Schritt für Schritt durch die ganze Gründung, statt 40 Browser-Tabs offen zu haben.
            </p>
          ...
          {/* Felix als free-standing Hero-Charakter */}
          <div className="relative flex justify-center lg:justify-end order-first lg:order-last">
            <div className="absolute inset-0 -z-10 flex items-center justify-center" aria-hidden="true">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full bg-primary/25 blur-3xl" />
            </div>
            <img
              src="/mascots/felix-front-t.png"
              alt="Felix, dein KI-Gründungs-Copilot, mit interaktiver Gründungs-Checkliste"
              className="w-56 sm:w-64 md:w-80 lg:w-full max-w-sm drop-shadow-xl animate-floaty"
